...
FRUITS = ["Апельсины", "Бананы", "Груши",
    "Мандарины", "Сливы", "Яблоки",]

def main(page: ft.Page):
    page.title = "Выбор CupertinoPicker"
    ...
    page.add(
        ft.SafeArea(
            content=ft.Row(
                tight=True,
                controls=[
                    ft.Text("Выбрано:", size=23),
                    ft.TextButton(style=ft.ButtonStyle(color=ft.Colors.BLUE),
