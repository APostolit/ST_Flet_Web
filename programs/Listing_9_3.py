...
def main(page: ft.Page):
    page.title = "Элемент перетаскивания Draggable"
    def handle_drag_will_accept(e: ft.DragWillAcceptEvent):
        e.control.content.border = ft.Border.all(2,
    ...
    page.add(
        ft.SafeArea(
            content=ft.Row(
                controls=[
                    ft.Column(
                        controls=[ft.Draggable(group="color",
                                               content=ft.Container(
                                                   width=50,
                                                   height=50,
                                                   bgcolor=ft.Colors.CYAN,
                                                   border_radius=5,),),
                                  ft.Draggable(group="color",
                                               content=ft.Container(
                                                   width=50,
                                                   height=50,
