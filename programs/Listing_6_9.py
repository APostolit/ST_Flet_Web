...
def main(page: ft.Page):
    ...
    menubar = ft.MenuBar(
        ...
        controls=[
            ft.SubmenuButton(
                content=ft.Text("Кнопка меню"),
                key="submenubutton",
                controls=[
                    ft.SubmenuButton(
                        content=ft.Text("Цвет фона"),
                    ...
                    ft.SubmenuButton(
                        content=ft.Text("Расположение текста"),
